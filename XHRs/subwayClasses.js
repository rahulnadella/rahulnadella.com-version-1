...
var bmhNode = new SingleNode(ProjectsLine,  new Point( 182-diff, Main_height-diff), null, 'Bayesian Methods for Hackers',new Point( 15, -16), 0);

    var projectsNode = new TransitionNode( MainLine, ProjectsLine, 0.79, new Point( 182, Main_height), null, 'Projects',  new Point( 12, -14),0 );
    var pyProcessNode = new SingleNode( ProjectsLine, new Point( 182+diff, Main_height+diff), null, 'PyProcess Library', new Point( 19, 0),0);
    
       var TwitterNode = new TransitionNode( ProjectsLine, TwitterLine, 0, new Point( p ,Twitter_height ), null, 'Twitter', new Point( 15, -20),0);
       var twittxorNode = new SingleNode( TwitterLine, new Point( p + 152, Twitter_height), null, 'Twittxor',  new Point( -30, -20),0 );
       var twArmyNode = new SingleNode( TwitterLine, new Point( p + 152*2-10, Twitter_height), null, 'The Twitter Projects', new Point( -70, -20), 0 );
        
//    OWONode = new SingleNode( ProjectsLine, new Point( 225, 255), null, 'One Week Of');
    var OWONode = new SingleNode( ProjectsLine, new Point(182+3*diff, Twitter_height + diff ), null, 'OWO Experiments', new Point( -50,28),0);
...
var researchNode = new SingleNode( MainLine, new Point( 334, Main_height), null, 'Research', new Point( 12, -14),0);
    ...
    var latestBlogNode = new SingleNode( BlogLine, new Point( 486 + 70, 45), null, 'Latest Blog',  new Point( 13, -14),0);
    var allBlogsNode = new SingleNode( BlogLine, new Point( 690, 45), null,'All Blogs', new Point( 13, -14),0);

var resumeNode = new SingleNode( MainLine, new Point(640, Main_height), null, 'Resume',new Point( 12, -14),0);
var twNode = new TransitionNode( MainLine, TwitterLine, -3.14, new Point( 640+2*diff, Twitter_height), null, '@cmrn_dp',new Point( 12,-14),0 );

//populuate neighbours.'S':projectsNode
homeNode.neighbours = {'E':projectsNode};
projectsNode.neighbours = {'W':homeNode, 'N':bmhNode, 'E':researchNode, 'S': pyProcessNode};
...
pyProcessNode.neighbours = {'N':projectsNode, 'S': TwitterNode, 'E': TwitterNode,'W':projectsNode };
OWONode.neighbours = {'W': TwitterNode, 'N':TwitterNode,};
TwitterNode.neighbours = {'W': pyProcessNode, 'N':pyProcessNode, 'E':twittxorNode, 'S':OWONode };
twittxorNode.neighbours = {'W': TwitterNode, 'E':twArmyNode };
twArmyNode.neighbours = {'W': twittxorNode, 'E':twNode };
//moreProjectsNode.neighbours = {'W':OWONode};
twNode.neighbours = {'N': resumeNode, 'W': twArmyNode }; 
